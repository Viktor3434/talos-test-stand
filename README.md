...
Если вы нашли ошибку или хотите предложить улучшение, создавайте Issue или Pull Request. Убедитесь, что ваши изменения не ломают существующие сценарии использования.

## 📄 Лицензия

Этот проект распространяется под лицензией, указанной в корне репозитория (обычно MIT или Apache 2.0). Подробности смотрите в файле LICENSE.
